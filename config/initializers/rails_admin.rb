# RailsAdmin config file. Generated on July 05, 2013 00:28
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Shigglez', 'Admin']
  ...
  # config.excluded_models = ['Rate', 'RatingCache', 'Restroom', 'Review', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Rate', 'RatingCache', 'Restroom', 'Review', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your rate.rb model definition

  #   # Found associations:

  #     configure :rater, :belongs_to_association 
  #     configure :rateable, :polymorphic_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your rating_cache.rb model definition

  #   # Found associations:

  #     configure :cacheable, :polymorphic_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :cacheable_id, :integer         # Hidden 
  #     configure :cacheable_type, :string         # Hidden 
  #     configure :avg, :float 
  ...
  # config.model 'Restroom' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your restroom.rb model definition
  ...
  #     configure :rate_average_without_dimension, :has_one_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :business_name, :string 
  ...
  #     configure :restroom, :belongs_to_association 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :restroom_id, :integer         # Hidden 
